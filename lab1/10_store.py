...
# или проще (/сложнее ?)
lamp_code = goods['Лампа'] #lamp_code=12345
lamps_item = store[lamp_code][0]#обращаемся к словарю store по ключу и входим про индексу в текущий список 
lamps_quantity = lamps_item['quantity']#из lamps_item берем значение quantity
lamps_price = lamps_item['price']#из lamps_item берем значение price
lamps_cost = lamps_quantity * lamps_price #умножаем  quantity*price
...
print('Лампа -', table_quantity, 'шт, стоимость', table_cost, 'руб')
...
print('Лампа -', sofa_quantity, 'шт, стоимость', sofa_cost, 'руб')
...
print('Лампа -', chair_quantity, 'шт, стоимость', chair_cost, 'руб')
